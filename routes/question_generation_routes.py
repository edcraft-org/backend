...
def get_autoloaded_classes() -> Dict[str, Dict[str, Type[Processor]]]:
...
async def get_topics_route(autoloaded_classes: Dict[str, Dict[str, Type[Processor]]] = Depends(get_autoloaded_classes)) -> List[str]:
    try:
...
async def get_subtopics_route(topic: str, autoloaded_classes: Dict[str, Dict[str, Type[Processor]]] = Depends(get_autoloaded_classes)) -> List[str]:
    try:
...
async def list_queryables_route(topic: str, subtopic: str, autoloaded_classes: Dict[str, Dict[str, Type[Processor]]] = Depends(get_autoloaded_classes)) -> List[str]:
    try:
...
async def list_variables_route(topic: str, subtopic: str, queryable: str, autoloaded_classes: Dict[str, Dict[str, Type[Processor]]] = Depends(get_autoloaded_classes)) -> List[str]:
    try:
...
async def generate_route(request: GenerateQuestionRequest, autoloaded_classes: Dict[str, Dict[str, Type[Processor]]] = Depends(get_autoloaded_classes)):
    results = []
    try:
